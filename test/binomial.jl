...
@test_approx_eq ci(BinomialTest(26, 78)) (0.2992950562085405,0.9251453685803082)
@test_approx_eq ci(BinomialTest(26, 78), tail=:left) (0.0,0.9022531865607242)
@test_approx_eq ci(BinomialTest(26, 78), tail=:right) (0.3449413659437032,1.0)
