...
@testset "Binomial" begin
    ...
    @test_ci_approx confint(t, method=:waldcc) (0.22230793880012298, 0.4443587278665436)
    @test_ci_approx confint(t, tail=:left, method=:waldcc) (0.0, 0.42753938126470326)
    @test_ci_approx confint(t, tail=:right, method=:waldcc) (0.23912728540196335, 1.0)
