...
@test t.g == 4
@test t.n == length(u5) + length(u250) + length(u2500) + length(more)
...
@test t.g == 4
@test t.n == length(city1) + length(city2) + length(city3) + length(city4)
...
@test_approx_eq t.C 0.9969565217391304
