...
@test [ci(t; tail=:left)...] ≈ [0.0, 76.24918299781056]
@test [ci(t; tail=:right)...] ≈ [0.013114894621608135, Inf]
@test [ci(t; method=:central)...] ≈ [0.006400016357911029, 156.2496006379585]
...
@test [ci(t; tail=:left)...] ≈ [0.0, 0.32600296913224913]
@test [ci(t; tail=:right)...] ≈ [0.0012948958389639856, Inf]
@test [ci(t; method=:central)...] ≈ [0.0006360029488751071, 0.42586647569637387]
...
@test [ci(t; tail=:left)...] ≈ [0.0, Inf]
@test [ci(t; tail=:right)...] ≈ [0.539859556284207, Inf]
@test [ci(t; method=:central)...] ≈ [0.39239937500428096, Inf]
...
@test pvalue(t; method=:minlike, tail=:both) ≈ 0.2720685111989459
@test [ci(t; tail=:left)...] ≈ [0.0, 1.852333608546057]
@test [ci(t; tail=:right)...] ≈ [0.0, Inf]
@test [ci(t; method=:central)...] ≈ [0.0, 2.5484240386190433]
...
@test pvalue(t; method=:central, tail=:both) ≈ 0.29117259552042146
@test pvalue(t; method=:minlike, tail=:both) ≈ 0.2720685111989459
@test [ci(t; tail=:left)...] ≈ [0.0, 1.8523336085460567]
@test [ci(t; tail=:right)...] ≈ [0.0, Inf]
@test [ci(t; method=:central)...] ≈ [0.0, 2.5484240386190433]
#@test_approx_eq [ci(t; method=:minlike)...] [0.0, 1.9338]
show(IOBuffer(), t)
...
@test pvalue(t; method=:minlike, tail=:both) ≈ 0.2720685111989459
@test [ci(t; tail=:left)...] ≈ [0.0, Inf]
@test [ci(t; tail=:right)...] ≈ [0.5398595562842079,Inf]
@test [ci(t; method=:central)...] ≈ [0.39239937500428096, Inf]
#@test_approx_eq [ci(t; method=:minlike)...] [0.5171, Inf]
show(IOBuffer(), t)
...
@test [ci(t; tail=:left)...] ≈ [0.0,25.20252454804777]
@test [ci(t; tail=:right)...] ≈ [1.2436262312601785, Inf]
@test [ci(t; method=:central)...] ≈ [0.8458141614657836, 29.44434308524672]
...
@test [ci(t; tail=:left)...] ≈ [0.0, 9.594302003876502]
@test [ci(t; tail=:right)...] ≈ [0.004963263361921223, Inf]
@test [ci(t; method=:central)...] ≈ [0.002430190787475382, 19.59477744071154]
