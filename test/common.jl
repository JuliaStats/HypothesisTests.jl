...
@test !occursin("confidence interval", repr("text/plain", RefusingCITest()))
@test occursin("95% confidence interval: (-1.0, 1.0)", repr("text/plain", WorkingCITest()))
@test_throws ArgumentError repr("text/plain", ArgumentBugCITest())
end
