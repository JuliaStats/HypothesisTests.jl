...
@test !occursin("confidence interval", sprint(show, MIME("text/plain"), RefusingCITest()))
@test occursin("95% confidence interval: (-1.0, 1.0)", sprint(show, MIME("text/plain"), WorkingCITest()))
@test_throws ArgumentError sprint(show, MIME("text/plain"), ArgumentBugCITest())
end
