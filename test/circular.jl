...
wind_direction_12pm =
	...
	23]*pi/180
@test abs(test_statistic(TLinearAssociation, wind_direction_6am, wind_direction_12pm) - 0.191) < 0.001
@test abs(p_value(TLinearAssociation, wind_direction_6am, wind_direction_12pm) - 0.01) < 0.01