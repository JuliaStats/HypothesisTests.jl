...
@testset "Circular" begin
    ...
    @testset "Fisher, 1995 example 4.12" begin
        t = RayleighTest([2, 9, 18, 24, 30, 35, 35, 39, 39, 44,
    ...
    wind_direction_6am = [356, 97, 211, 232, 343, 292, 157, 302, 335, 302,
                          324, 85, 324, 340, 157, 238, 254, 146, 232, 122,
                          329]*pi/180
    wind_direction_12pm = [119, 162, 221, 259, 270, 29, 97, 292, 40, 313,
